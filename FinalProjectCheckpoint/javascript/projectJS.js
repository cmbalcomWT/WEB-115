...
document.addEventListener('DOMContentLoaded',function(){
    ...
    function newWindow(event){
        ...
        resultText = ("<html><head><title>Weekly Goal</title></head><body><div id='contentDiv'>");
        resultText += ("Hello " + userName + " at " + userEmail + "!");
        resultText += ("<br/>Here is your weekly goal:<br/>");
        resultText += ("<br/>Monday: " + generateGoal(monGoal) + "<br/>");
        resultText += ("<br/>Tuesday: " + generateGoal(tuesGoal) + "<br/>");
        resultText += ("<br/>Wednesday: " + generateGoal(wedGoal) + "<br/>");
        resultText += ("<br/>Thursday: " + generateGoal(thursGoal) + "<br/>");
        resultText += ("<br/>Friday: " + generateGoal(friGoal) + "<br/>");
        resultText += ("<br/>Saturday: " + generateGoal(satGoal) + "<br/>");
        resultText += ("<br/>Sunday: " + generateGoal(sunGoal) + "<br/></div>");
